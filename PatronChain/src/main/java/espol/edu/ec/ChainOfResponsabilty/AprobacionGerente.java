...
public class AprobacionGerente extends SolicitudDeCambio {

    public AprobacionGerente(Producto p){
        super(p);
    }
    ...
    public void iniciarProceso(String description) {
        if(esPosible()){
            System.out.println("Gerente validando la aprobacion del producto...");
